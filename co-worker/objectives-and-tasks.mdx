...
This page defines the words, says where each surfaces, and covers the Tasks page, where you can start an objective yourself. That page is titled **Beetle Tasks**; Beetle is the assistant's name in the interface.
